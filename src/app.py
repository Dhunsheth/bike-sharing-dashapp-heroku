...
rider_trend_hour_url = 'https://github.com/Dhunsheth/dash_python_dashboard/raw/main/data/processed/rider_trend_hour.parquet'
response = requests.get(rider_trend_hour_url)
if response.status_code == 200:
    rider_trend_hour = pd.read_parquet(BytesIO(response.content))


rider_trend_day_url = 'https://github.com/Dhunsheth/dash_python_dashboard/raw/main/data/processed/rider_trend_day.parquet'
response = requests.get(rider_trend_day_url)
if response.status_code == 200:
    rider_trend_day = pd.read_parquet(BytesIO(response.content))


rider_trend_month_url = 'https://github.com/Dhunsheth/dash_python_dashboard/raw/main/data/processed/rider_trend_month.parquet'
response = requests.get(rider_trend_month_url)
if response.status_code == 200:
    rider_trend_month = pd.read_parquet(BytesIO(response.content))


stations_comparison_url = 'https://github.com/Dhunsheth/dash_python_dashboard/raw/main/data/processed/station_comparison.parquet'
response = requests.get(stations_comparison_url)
if response.status_code == 200:
    stations_comparison = pd.read_parquet(BytesIO(response.content))

station_list_url = 'https://github.com/Dhunsheth/dash_python_dashboard/raw/main/data/processed/station_list.parquet'
response = requests.get(station_list_url)
if response.status_code == 200:
    station_list = pd.read_parquet(BytesIO(response.content))
